...
intro.write('Use W A S D Keys to Move',font=['Courier',30],align='center')
...
def spawn_berry(pos,size):
    ...
    return berry
berry_size =1.2
berry = spawn_berry([rd.randint(int(-width/2),int(width/2)), rd.randint(int(-height/2),int(height/2))],berry_size)
berry.showturtle()
